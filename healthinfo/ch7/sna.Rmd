...
```{r, fig.align = 'center', fig.height = 10, eval = F}

# get adjacency matrix
A <- as_adjacency_matrix(karate, sparse = F)
g <- network::as.network.matrix(A)
par(mfrow = c(1, 2))
sna::gplot.target(g, degree(g), circ.lab = F, circ.col = "blue", usearrows = F, edge.col = "darkgray")
sna::gplot.target(g, closeness(g), circ.lab = F, circ.col = "blue", usearrows = F, edge.col = "darkgray")
