...
# create a data frame
t <- 1:max(length(sales.base$basesales), length(sales.dc), length(sales.cc))
# adding zeros
addzeros <- function(x, tmax) {
  if (length(x) < tmax) {
    # adding zeros
...
# create a data frame
t <- 1:max(length(sales.base$basesales), length(sales.dc), length(sales.cc), length(sales.bc))
# adding zeros
addzeros <- function(x, tmax) {
  if (length(x) < tmax) {
    # adding zeros
